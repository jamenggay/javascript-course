...
class App {
  ...
  _newWorkout(e) {
    // helper function
    //validate input that they are actual numbers that make sens
    ...
    if (type === 'running') {
      ...
      //create the running object with map coordinated and form data
      workout = new Running([lat, lng], distance, duration, cadence);
    }
    //cycling workout creating
    if (type === 'cycling') {
